"""Factory for creating CLIP models and loading pretrained weights"""
...
def _rescan_model_configs():
    """scan model config paths for model configs and update registry"""
...
def create_model(
    ...
    if pretrained and pretrained.lower() == "openai":
        ...
        custom_text = (
            ...
            or ("hf_model_name" in model_cfg.get("text_cfg", {}))
        )
...
def create_model_and_transforms(
    ...
    """Create a CLIP model and image transforms."""
    model = create_model(
        model_name,
        pretrained,
        precision=precision,
...
def create_model_from_pretrained(
    ...
    """Create a CLIP model from a pretrained checkpoint or config."""
