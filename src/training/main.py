...
try:
    from torch.utils import tensorboard  # pylint: disable=ungrouped-imports
except ImportError:
...
def main(args):
    ...
    if is_master(args):
        ...
        with open(params_file, "w", encoding="utf8") as f:
...
def copy_codebase(args):
    """Copy the codebase to the logs directory."""
    from shutil import copytree, ignore_patterns  # pylint: disable=import-outside-toplevel
